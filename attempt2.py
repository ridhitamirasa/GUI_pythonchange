...
#canvas.create_image(0, -10, image=photo, anchor=tk.NW)
image_label = tk.Label(root, image=photo, bd=0)
image_label.place(x=200, y=300)

# Define the positions and colors of element tiles
element_positions = {
    "H": {"position": (200, 300), "color": "lightblue"},
    "He": {"position": (768, 300), "color": "lightgreen"},
   # "Li": {"position": (200, 114), "color": "pink"},
  #  "Be": {"position": (200, 114), "color": "lightyellow"},
